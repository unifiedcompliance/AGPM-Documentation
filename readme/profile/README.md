...
A User can belong to more than one Account.  Select the _Associated Accounts_ link of the Profile page and you will see all of the accounts the logged-in user belongs to.  To switch from one account to another, select the profile dropdown in the top right hand header link of the application and select the account to switch to.  In the list of associated accounts you will see:
